...
*/
  ...
  define('MODULE_PAYMENT_CGP_PAYSAFECASH_TEXT_DESCRIPTION', 'You can sign up for a CardGate account  <a href="https://www.cardgate.com/en/sign-up/">here</a>.');
  ...
  define('MODULE_PAYMENT_CGP_PAYSAFECASH_TEXT_ERROR', 'An error has occured');
  define('MODULE_PAYMENT_CGP_PAYSAFECASH_TEXT_ERROR_MESSAGE', 'There has been an error processing your payment. Please try again.');
