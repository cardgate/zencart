...
class cgp_sofortbanking extends cgp_generic{

	var $debug 					= false;
	var $module_payment_type 	= 'MODULE_PAYMENT_CGP_SOFORTBANKING';
	var $payment_option 		= 'sofortbanking';
